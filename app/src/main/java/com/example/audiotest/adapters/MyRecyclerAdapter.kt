...
class MyRecyclerAdapter(val context : Context, var slizes : List<Slize>, var audioHelper : AudioHelper) : RecyclerView.Adapter<MyRecyclerAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.slice_item, parent, false))
    }
